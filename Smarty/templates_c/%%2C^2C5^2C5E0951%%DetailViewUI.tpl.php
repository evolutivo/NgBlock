...
####<?php echo $_SESSION['internal_mailer']; ?>
	 ...
	 <?php elseif (( $this->_tpl_vars['keyid'] == '15' || $this->_tpl_vars['keyid'] == '16' ) && ! picklistHasDependency ( $this->_tpl_vars['keyfldname'] , $this->_tpl_vars['MODULE'] )): ?> <!--ComboBox-->
...
"><?php echo $this->_tpl_vars['keyval']; ?>
                                             ...
                                             <?php elseif ($this->_tpl_vars['keyid'] == '57' || $this->_tpl_vars['keyid'] == '58'): ?> <!--ContactPopup-->
...
?>
							<tr style="height:25px">
								<td align="right" class="dvtCellLabel"><?php echo $this->_tpl_vars['tax']['taxlabel']; ?>
 <?php echo $this->_tpl_vars['APP']['COVERED_PERCENTAGE']; ?>
</td>
								<td class="dvtCellInfo" align="left"><?php echo $this->_tpl_vars['tax']['percentage']; ?>
</td>
...
", singleClick : true, step : 1
				...
				<?php elseif ($this->_tpl_vars['keyid'] == 10): ?><!-- for vtlib reference field -->
     				<td class="dvtCellInfo" align="left" width=25% onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this));" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">&nbsp;<?php echo $this->_tpl_vars['keyval']; ?>
</td>
				<?php else: ?>
