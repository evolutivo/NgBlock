<?php /* Smarty version 2.6.18, created on 2014-12-12 23:42:29
         compiled from modules/NgBlock/index.tpl */ ?>
                     ...
                     <td   ng-controller="ng_Block">   
                        ...
                        <tr style="background-color:#c9dff0">
                            ...
                            <tr ng-repeat="user in $data" >
                              ...
                              <td  > 
                                  <?php echo '  {{user.module_name_trans}}'; ?>

                              </td> 
                              <td  > 
                                  <?php echo '  {{user.pointing_block_name_trans}}'; ?>

                              </td> 
                              <td > 
                                  <?php echo '  {{user.pointing_module_name_trans}}'; ?>

                              </td> 
                              <td  > 
                                  <?php echo '  {{user.pointing_field_name_trans}}'; ?>

                              </td> 
                              <td  > 
                                  <?php echo '  {{user.columns}}'; ?>
