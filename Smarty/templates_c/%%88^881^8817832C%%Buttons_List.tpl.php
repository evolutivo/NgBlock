...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Buttons_List.tpl', 22, false),array('modifier', 'vtiger_imageurl', 'Buttons_List.tpl', 38, false),)), $this); ?>
				...
				<tr>
					<?php if ($this->_tpl_vars['CALENDAR_DISPLAY'] == 'true'): ?> 
						<?php if ($this->_tpl_vars['CATEGORY'] == 'Settings' || $this->_tpl_vars['CATEGORY'] == 'Tools' || $this->_tpl_vars['CATEGORY'] == 'Analytics'): ?>
							<?php $this->assign('PTCATEGORY', 'My Home Page'); ?>
						<?php else: ?>
							<?php $this->assign('PTCATEGORY', $this->_tpl_vars['CATEGORY']); ?>
						<?php endif; ?>
						<?php if ($this->_tpl_vars['CHECK']['Calendar'] == 'yes'): ?> 
							<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;" onClick='fnvshobj(this,"miniCal");getMiniCal("parenttab=<?php echo $this->_tpl_vars['PTCATEGORY']; ?>
");'><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
...
" border="0"></td>
			...
			<?php if ($this->_tpl_vars['MODULE'] == 'Contacts' || $this->_tpl_vars['MODULE'] == 'Leads' || $this->_tpl_vars['MODULE'] == 'Accounts' || $this->_tpl_vars['MODULE'] == 'Products' || $this->_tpl_vars['MODULE'] == 'Potentials' || $this->_tpl_vars['MODULE'] == 'HelpDesk' || $this->_tpl_vars['MODULE'] == 'Vendors' || $this->_tpl_vars['CUSTOM_MODULE'] == 'true'): ?>
				<?php if ($this->_tpl_vars['CHECK']['DuplicatesHandling'] == 'yes' && ( $_REQUEST['action'] == 'ListView' || $_REQUEST['action'] == 'index' )): ?>
...
" alt="<?php echo $this->_tpl_vars['APP']['LBL_FIND_DUPLICATES']; ?>
