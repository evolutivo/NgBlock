<?php /* Smarty version 2.6.18, created on 2014-12-12 23:38:35
         compiled from Header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Header.tpl', 15, false),array('modifier', 'vtiger_imageurl', 'Header.tpl', 101, false),array('modifier', 'escape', 'Header.tpl', 188, false),array('modifier', 'vtlib_purify', 'Header.tpl', 382, false),)), $this); ?>
...
<head>
 ...
 - <?php echo $this->_tpl_vars['APP']['LBL_BROWSER_TITLE']; ?>
	...
	<link REL="SHORTCUT ICON" HREF="test/logo/<?php echo $this->_tpl_vars['FAVICON']; ?>
">
...
'; ?>
	...
	<!-- End -->
<?php if ($this->_tpl_vars['MODULE'] != 'FieldFormulas' && $this->_tpl_vars['MODULE'] != 'com_vtiger_workflow' && $this->_tpl_vars['MODULE'] != 'evvtApps'): ?> 
...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="small">
	<tr>
		<td valign=top align=left><img src="test/logo/<?php echo $this->_tpl_vars['FRONTLOGO']; ?>
" alt="<?php echo $this->_tpl_vars['COMPANY_DETAILS']['name']; ?>
" title="<?php echo $this->_tpl_vars['COMPANY_DETAILS']['name']; ?>
			...
			<tr>
				<td valign="top" class="genHeaderSmall" style="padding-left:10px;padding-top:3px;">
					<span class="userName"><?php echo $this->_tpl_vars['USER']; ?>
								...
								<td class="small" valign="bottom" nowrap style="padding-bottom: 1em;"><a href="index.php?module=Users&action=DetailView&record=<?php echo $this->_tpl_vars['CURRENT_USER_ID']; ?>
&modechk=prefview"><img src="<?php echo $this->_tpl_vars['IMAGEPATH']; ?>
user.PNG" border=0 style="padding: 0px;padding-left:5px" title="<?php echo $this->_tpl_vars['APP']['LBL_MY_PREFERENCES']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_MY_PREFERENCES']; ?>
"></a></td>
			...
			<td style="padding-bottom:1em;padding-left:10px;padding-right:5px" class=small nowrap valign="bottom">
				<a href="javascript:;" onmouseover="fnvshobj(this,'vtlib_headerLinksLay');" onclick="fnvshobj(this,'vtlib_headerLinksLay');"><img src="<?php echo vtiger_imageurl('menu_more.png', $this->_tpl_vars['THEME']); ?>
...
?>
						<?php if ($this->_tpl_vars['maintabs'] == 'Settings'): ?>
							<td  valign="bottom" nowrap style="padding-bottom: 1em;" class="small" onmouseout="fnHideDrop('mainsettings');" onmouseover="fnDropDown(this,'mainsettings');" nowrap><a href="index.php?module=Settings&action=index&parenttab="><img src="<?php echo $this->_tpl_vars['IMAGEPATH']; ?>
mainSettings.PNG"  border=0 style="padding: 0px;padding-left:5px "></a></td>
						<?php endif; ?>
					<?php endforeach; endif; unset($_from); ?>
				<?php endif; ?>
				<td  valign="bottom" nowrap style="padding-bottom: 1em;" class="small" nowrap><a href="index.php?module=Users&action=Logout"> <img src="themes/images/logout.png" border=0 style="padding: 0px;padding-left:5px " title="<?php echo $this->_tpl_vars['APP']['LBL_LOGOUT']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_LOGOUT']; ?>
"></a></td>
			</tr>
			</table>
        </td>
		...
		<tr>
			<td class="small">
				...
				<tr>
					...
					<td align="left">
						<input class="small" type='text' name='ics_filename' id='ics_filename' size='25' value='<?php global $coreBOS_app_name; echo $coreBOS_app_name; ?>.calendar'/>
					</td>
				</tr>
				</table>
			</td>
...
?>
					<?php if ($this->_tpl_vars['maintabs'] == 'more' && $this->_tpl_vars['detail'] != null): ?>
						<td class="tabUnSelected"  align="center" onmouseout="fnHide_Event('allMenu');" onmouseover="fnvshobjMore(this,'allMenu',<?php if ($this->_tpl_vars['ANNOUNCEMENT']): ?>true<?php else: ?>false<?php endif; ?>);"nowrap><a href="javascript:;" ><?php echo $this->_tpl_vars['APP']['LBL_MORE']; ?>
...
<div  id="usersettings" class="drop_mnu_user" onmouseout="fnHideDrop('usersettings');" onmouseover="fnvshNrm('usersettings');"  style="width:110px;left:1226px;">
	<table border=0 width="100%" border="0" cellpadding="0" cellspacing="0" >
		<tr>
			<td style="padding-left:0px;padding-right:10px font-weight:bold"  nowrap> <a href="<?php echo @MAIN_HELP_PAGE; ?>
" target="_blank" class="drop_down_usersettings"><?php echo $this->_tpl_vars['APP']['LNK_HELP']; ?>
</a> </td>
		</tr>
	</table>
</div>
...
&action=index&parenttab=" class="drop_down_usersettings"><?php echo getTranslatedString($this->_tpl_vars['detail'][0], $this->_tpl_vars['detail'][0]); ?>
</a></td></tr>
			<?php endif; ?>
		<?php endforeach; endif; unset($_from); ?>
		<tr><td style="padding-left:0px;padding-right:10px font-weight:bold"  nowrap><a href="index.php?module=Settings&action=index&parenttab=" class="drop_down_usersettings"><?php echo getTranslatedString('LBL_CRM_SETTINGS', $this->_tpl_vars['MODULE_NAME']); ?>
</a></td></tr>
	</table>
</div>
<script type="text/javascript">
