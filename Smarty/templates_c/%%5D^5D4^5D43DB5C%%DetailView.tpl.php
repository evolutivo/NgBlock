<?php /* Smarty version 2.6.18, created on 2014-12-12 23:43:26
...
"><?php echo getTranslatedString($this->_tpl_vars['_RELATED_MODULE'], $this->_tpl_vars['_RELATED_MODULE']); ?>
</a></td></tr>
...
?>
																			<?php if (preg_match ( "/^block:\/\/.*/" , $this->_tpl_vars['CUSTOM_LINK_DETAILVIEWWIDGET']->linkurl )): ?>
																			 <?php if (( is_numeric ( $this->_tpl_vars['CUSTOM_LINK_DETAILVIEWWIDGET']->linklabel ) ) || ( ($this->_foreach['BLOCKS']['iteration'] <= 1) && $this->_tpl_vars['CUSTOM_LINK_DETAILVIEWWIDGET']->sequence <= 1 ) || ( $this->_tpl_vars['CUSTOM_LINK_DETAILVIEWWIDGET']->sequence == $this->_foreach['BLOCKS']['iteration'] ) || ( ($this->_foreach['BLOCKS']['iteration'] == $this->_foreach['BLOCKS']['total']) && $this->_tpl_vars['CUSTOM_LINK_DETAILVIEWWIDGET']->sequence >= $this->_foreach['BLOCKS']['iteration'] )): ?>
																				<tr>
																					<td style="padding:5px;" >
																						<?php  echo vtlib_process_widget($this->_tpl_vars['CUSTOM_LINK_DETAILVIEWWIDGET'], $this->_tpl_vars);  ?>
																					</td>
																				</tr>
																			 <?php endif; ?>
																			<?php endif; ?>
...
"><?php echo $this->_tpl_vars['APP']['LBL_CREATE']; ?>
 <?php echo $this->_tpl_vars['APP']['Invoice']; ?>
														...
														<?php endif; ?>
													<?php elseif ($this->_tpl_vars['TODO_PERMISSION'] == 'true' || $this->_tpl_vars['EVENT_PERMISSION'] == 'true' || $this->_tpl_vars['CONTACT_PERMISSION'] == 'true' || $this->_tpl_vars['MODULE'] == 'Contacts' || $this->_tpl_vars['MODULE'] == 'Leads' || ( $this->_tpl_vars['MODULE'] == 'Documents' )): ?>
