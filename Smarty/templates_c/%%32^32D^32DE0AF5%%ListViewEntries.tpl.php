...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'ListViewEntries.tpl', 113, false),array('modifier', 'vtiger_imageurl', 'ListViewEntries.tpl', 142, false),array('modifier', 'count', 'ListViewEntries.tpl', 251, false),array('function', 'html_options', 'ListViewEntries.tpl', 296, false),)), $this); ?>
...
</font></b> <SELECT NAME="viewname" id="viewname" class="small" style="max-width:240px;" onchange="showDefaultCustomView(this,'<?php echo $this->_tpl_vars['MODULE']; ?>
...
"><?php echo $this->_tpl_vars['APP']['LNK_CV_CREATEVIEW']; ?>
													...
													<span class="small">|</span>
													<?php if ($this->_tpl_vars['CV_EDIT_PERMIT'] != 'yes' || $this->_tpl_vars['SQLERROR']): ?>
														<span class="small" disabled><?php echo $this->_tpl_vars['APP']['LNK_CV_EDIT']; ?>
</span>
													<?php else: ?>
														<a href="index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
...
')"><?php echo $this->_tpl_vars['CUSTOMVIEW_PERMISSION']['Label']; ?>
			   		...
			   		<tr>
					<!-- Buttons -->
					<td style="padding-right:20px" nowrap><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'ListViewButtons.tpl', 'smarty_include_vars' => array()));
...
">
			<div style="border: 3px solid rgb(153, 153, 153); background-color: rgb(255, 255, 255); width: 45%; position: relative; z-index: 10000000;">
				...
				<?php if ($this->_tpl_vars['SQLERROR']): ?>
...
<?php endif; ?> <?php echo $this->_tpl_vars['APP']['LBL_FOUND']; ?>
 !
				...
				<tr>
					<td class="small" align="left" nowrap="nowrap"><?php echo getTranslatedString('ERROR_GETTING_FILTER', $this->_tpl_vars['MODULE']); ?>
</td>
				</tr>
				</table>
				<?php else: ?>
